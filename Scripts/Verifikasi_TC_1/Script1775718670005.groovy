...
WebUI.click(findTestObject('Page_CURA Healthcare Service/a_btn-make-appointment'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/h2_Appointment Confirmation'), 'Appointment Confirmation 123')
